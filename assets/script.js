...
var questions = ["What Soccer club has the most champions league titles?","Every how many years is there a world cup?", "Which country has the most World Cup Titles", "What club did Messi start his career at?", "What Country will host the 2022 world cup?"];
// allCorrectAnswer contains the correct answers in order of question number
var allCorrectAnswer = ["Real Madrid","Every 4 years", "Brazil", "Barcelona", "Qatar"];
...
allAnswers[0] = new Array ("Real Madrid", "Barcelona", "Manchester United", "Juventus");
allAnswers[1] = new Array ("Every 4 years", "Every 2 years", "Every year", "Once a decade");
allAnswers[2] = new Array ("Brazil", "France", "England","Germany");
allAnswers[3] = new Array ("Barcelona", "Argentina", "Manchester United", "PSG");
allAnswers[4] = new Array ("Qatar", "Dubai", "France", "Russia");
